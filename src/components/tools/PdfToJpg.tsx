...
import { Upload, Image, Download, X, FileText, CheckCircle, AlertCircle, Loader2 } from "lucide-react";
...
export default function PdfToJpg() {
  ...
  const downloadImage = (imgUrl: string, index: number) => {
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    {loading ? "Converting..." : formatFileSize(file.size)}
                  </p>
                </div>
              </div>
              <button
