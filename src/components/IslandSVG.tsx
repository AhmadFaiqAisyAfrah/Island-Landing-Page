export default function IslandSVG({ className = "", isFocusing = false }: { className?: string; isFocusing?: boolean }) {
    return (
        <svg
            viewBox="0 0 500 450"
            fill="none"
        ...
        >
            ...
            <g className={`origin-center ${isFocusing ? 'animate-breathe' : 'animate-float-slow'}`}>
                ...
                {/* Window left */}
                <circle cx="207" cy="228" r="8" fill="#B8DFF0" stroke="#5C3A1E" strokeWidth="1.5" className={`transition-all duration-1000 ${isFocusing ? 'fill-[#fef08a] drop-shadow-[0_0_8px_#fef08a]' : ''}`} />
                ...
                {/* Window right */}
                <circle cx="263" cy="228" r="8" fill="#B8DFF0" stroke="#5C3A1E" strokeWidth="1.5" className={`transition-all duration-1000 ${isFocusing ? 'fill-[#fef08a] drop-shadow-[0_0_8px_#fef08a]' : ''}`} />
